    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CPU-I9-14", 1, 1, "High-end desktop CPU", "Intel Core i9-14900K" },
                    { "GPU-RTX40", 3, 2, "Flagship GPU", "NVIDIA GeForce RTX 4090" },
                    { "RAM-DDR5A", 2, 3, "High-speed DDR5 kit", "AMD EXPO DDR5 32GB" }
                });
